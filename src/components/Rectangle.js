    ...
    <div className="rectangle-back">
      <Grid columns={2}>
        ...
        <Grid.Row style={{ margin: '0px', width: '25px' }}>
          <Grid.Column>
            <div className="Lorem-Ipsum-is-simply-dummy-text-of-the-printing-industry">
        ...
        <Grid.Row style={{ margin: '0px' }}>
          <Grid.Column>
            <div className="Lorem-Ipsum-has-been">
        ...
        <Grid.Row>
          <Grid.Column style={{ margin: '0px' }}>
            <Input
              ...
              size="large"
              iconPosition="left"
              style={{ width: '425px', backgroundColor: 'black' }}
        ...
        <Grid.Row>
          <Grid.Column>
            <Button color="orange" size="large" style={{ width: '425px' }}>
              Giriş Yap
            </Button>
          </Grid.Column>
        </Grid.Row>
        <Grid.Row style={{ margin: '0px' }}>
          <Grid.Column>
            <span className="Ya-da-sosyal-medya-araclyla-ile">
              Ya da sosyal medya aracılığıyla ile
            </span>
          </Grid.Column>
        </Grid.Row>
        <Grid.Row
          style={{ color: 'white', margin: '0px', marginLeft: '160px' }}
        >
          <Grid.Column>
        ...
        <Grid.Row style={{ margin: '0px' }}>
          <Grid.Column>
            <div className="Aramza-katlmak-ister-misin-Kayt-Ol">
